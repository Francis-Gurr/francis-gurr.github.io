...
% Experience headings \xp{Name}{Place}{Date}
\newcommand{\xp}[3]{
	\vspace{0.25em}
...
% Custom itemise
\usepackage{xparse}
\NewDocumentEnvironment{itemise}{O{1em} O{-0.25em} O{-0.5em}}
	...
	\noindent\fcolorbox{sidebar_color}{sidebar_color}{%
		...
		\begin{minipage}{0.33\textwidth}
			...
			\begin{minipage}{0.87\textwidth}
				...
				% CONTACT
				\begin{itemise}[2em][0em][0em]
					\item[\faHome] Sheffield, UK
					\item[\faEnvelope] \href{mailto:francisgurr@gmail.com}{francisgurr@gmail.com}
					\item[\faGlobe] \href{http://www.francisgurr.com}{francisgurr.com}
				...
				% SUMMARY
				\section{Summary}
				Recent Electronic Engineering (MEng) graduate from  Durham University.
				...
				% SKILLS
				\section{Skills\vspace{-0.25em}}
				\emph{Confident:\vspace{0.25em}}\\
				\skill{Java}
				\skill{Python}
				\skill{C}
				\skill{MatLab}
				...
				\begin{itemise}[2em][-0.25em][-0.5em]
